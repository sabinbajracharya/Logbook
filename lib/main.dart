    ...
    body:_l
      ...
      Center(
        child:C(
          height:25,
          width:50,
          child:FlareActor("assets/l",fit:BoxFit.contain,animation:"l"),
        ),
      )
      :
      C(
                    ...
                    child:PageView.builder(
                      ...
                      itemBuilder:(_,i)=>C(
                        ...
                        child:ClipRRect(
                          ...
                          child:InkWell(
                            onTap:()=>_pCtrl.animateToPage(i, duration: new Duration(milliseconds: 350),curve: Curves.easeIn),
                            child:Image.asset(
                              _d['d'][i]['i'],
                              color:i==np?colr(lpd(1-fade)):i==cp?colr(lpd(fade)):colr(140),
                ...
                IgnorePointer(
                  child:C(
                    ...
                    decoration:BoxDecoration(
                      ...
                      border:Border.all(color:colr(52),width:8)
                    ),
                    child:C(
                      height:20,
                      width:120,
